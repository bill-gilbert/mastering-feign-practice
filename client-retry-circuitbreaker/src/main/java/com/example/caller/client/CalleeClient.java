...
@FeignClient(name = "calleeService", url = "${callee.url:http://localhost:18080}", configuration = CalleeServiceConfiguration.class, fallbackFactory = CalleeFallbackFactory.class)
